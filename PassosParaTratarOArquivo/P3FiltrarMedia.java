package PassosParaTratarOArquivo;
...
public class P3FiltrarMedia {
    ...
    public static BufferedReader lerArquivo() {
        ...
        String inputFile = caminho.getAbsolutePath() + "/DadosCsv/LA_Metro_BikeSharing_CLEANED_2016quater3-2021q3.csv";
        try {
    ...
    public static void filtrarArquivo(Double media) throws IOException{
        String outputFile = "./DadosCsvTratados/DadosComDuraçãoMaiorQueAMedia.csv"; 
        BufferedReader reader = lerArquivo();
